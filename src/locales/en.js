...
export default {
  ...
  brand: {
    ...
    tagline: 'A smile should not only be neat, but also shine with confidence.',
  ...
  invisibleBraces: {
      ...
      plans: {
        mild: {
          ...
          checks: [
            ...
            'No attachment design, clean and natural'
          ]
        },
        moderate: {
          tag: 'Moderate',
          ...
          checks: [
            ...
            'Meeting most adult orthodontic needs'
          ]
        },
        severe: {
          tag: 'Severe',
    ...
    brandCompare: {
      ...
      metrics: {
        material: 'Aligner Material',
        production: 'Production Location',
        certification: 'Medical Device Certification',
        service: 'Customer Service',
        cost: 'End-user Cost',
        transparency: 'Aligner Transparency',
      ...
      brands: {
        ...
        pearlDigital: 'PEARL DIGITAL',
        zBrand: 'Z Brand',
        dentalTech: 'Dental Tech Brand'
      },
      data: {
        material: {
          iBrand: 'Proprietary Material',
          pearlDigital: 'Proprietary Material',
          zBrand: 'Medical Device Certified Material',
          dentalTech: 'General Dental Tech Material'
        },
        production: {
          iBrand: 'Mexico\nImported',
          pearlDigital: 'Taiwan QMS\nMedical Device Factory',
          zBrand: 'China\nImported',
          dentalTech: 'Dental Lab Self-produced'
        },
        certification: {
          iBrand: 'Taiwan FDA Certified\nTaiwan TFDA class II\nMedical Device License',
          pearlDigital: 'US FDA Certified\nTaiwan TFDA class II\nMedical Device License',
          zBrand: 'Taiwan TFDA class II\nMedical Device License',
          dentalTech: 'X'
        },
        service: {
          iBrand: 'Central & South America Customer Service',
          pearlDigital: 'Taiwan Local\nSmile Care Manager',
          zBrand: 'APP Tracking',
          dentalTech: 'Brand End'
        },
        cost: {
          iBrand: 'US Medical Device Brand\n>200,000',
          pearlDigital: 'US Medical Device Brand\nStarting from $48,000',
          zBrand: 'Singapore Brand\nStarting from $72,000',
          dentalTech: 'Dental Lab Self-produced\nPrice not transparent'
        },
        transparency: {
          iBrand: 'Medium\nVisible stripes',
          pearlDigital: 'High transparency',
          zBrand: 'Frosted\nNot clear',
          dentalTech: 'Depends on production\nNo quality management system'
        },
        software: {
          iBrand: '○',
          pearlDigital: '○\nLegal software medical device',
          zBrand: '○',
          dentalTech: 'X'
        },
        productionTime: {
          iBrand: '2-3 weeks',
          pearlDigital: '5 business days',
          zBrand: '2-3 weeks',
          dentalTech: '7-10 days'
        }
      }
    }
  },
  ...
  login: {
    ...
    account: 'Account',
    accountTooltip: 'Please enter your smile test UUID',
    ...
    errorMessages: {
      enterUuid: 'Please enter UUID',
      enterCredentials: 'Please enter username and password',
      uuidValidationFailed: 'UUID validation failed',
...
`,
  ...
  faq: {
    ...
    questions: {
      process: {
        ...
        answer: 'Online appointment booking and selfie smile photo test (free service)\nDetailed consultation at the clinic with 3D oral scan/X-ray examination\nClinical dentist leads the design, AI assists in simulation, determining the complexity of the treatment plan\nConfirm treatment plan, sign contract, and make payment\nBraces manufactured in Taiwan QMS/GMP factory, pick up at clinic after approximately 2-3 weeks\nOfficially begin wearing, 20-22 hours daily, and regular follow-up visits'
      },
      duration: {
      ...
      pricing: {
        ...
        answer: 'Online appointment booking and selfie smile photo test are completely free. Doctors will determine if treatment is suitable based on uploaded oral photos.\nIf suitable for treatment, formal clinic oral assessment (including 3D oral scan and X-ray imaging) will be arranged. The cost for oral scan and X-ray examination is NT$3,000 (charged by the clinic, actual amount depends on the clinic).\n\nTreatment plan pricing:\n• Mild: Front teeth micro-adjustment, mild alignment issues - NT$48,000\n• Moderate: Front teeth + partial back teeth, moderate alignment or crowding issues - NT$98,000\n• Severe: Full mouth adjustment, improving bite and skeletal symmetry - NT$118,000\n\nRetainer set pricing:\n• 2-piece set - NT$11,000\n• 3-piece set - NT$14,000\n• 5-piece set - NT$19,000\n\nReminder: During follow-up visits, the attending physician will determine whether the last set of braces can be directly used to make retainers, or if re-scanning is needed to make retainers. If re-scanning is needed, the clinic will charge NT$3,000 (charged by the clinic).\n\nWe are committed to transparent pricing with no hidden fees. All costs will be clearly explained by our smile specialists before treatment, allowing you to choose with confidence and arrange with peace of mind.'
      },
      payment: {
  ...
  footer: {
    ...
    services: 'Services',
    about: 'About',
    privacyMessage: 'Please do not sell or share my personal information',
    privacyPolicy: 'Privacy Policy',
    termsOfService: 'Terms of Service',
