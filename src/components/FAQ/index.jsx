...
const faqList = [
  ...
  },
  {
    ...
    a: (
      <>
        大多數人在配戴2-4個月內就能感受到明顯變化,例如前牙對齊或縫隙縮小。雖然療程初期效果可能明顯, 但最終結果需依整體療程進度評估。
      </>
    )
  },
  {
    ...
    a: (
      <>
        我們提供專為青少年設計的療程選項。<br />
        具備穩定配戴習慣的<br />
        **中學階段學生(約12歲以上)經由牙醫師評估後, 即可進行療程規劃。**<br />
  ...
  },
  {
    ...
    a: (
      <>
        ...
        如需重新掃描,診所將酌收重新掃描費用$3000,這筆費用您將直接支付給診所。<br />
        讓您能獲得理想笑容,是我們的承諾與責任。
      </>
    )
  },
