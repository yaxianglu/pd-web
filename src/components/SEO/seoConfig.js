...
export const seoConfig = {
  home: {
    ...
    keywords: 'clear aligner, invisible braces, orthodontics, teeth straightening, FDA cleared, AI orthodontics, medical grade, transparent aligners, bite correction, malocclusion treatment',
    url: '/',
    structuredData: {
